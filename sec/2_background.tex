...
Generative models are a hot topic today, with massive strides being made in image generation. In previous attempts to accomplish this, models were trained to directly generate images. However, more recent approaches treat the task as a domain transport problem (i.e. mapping a normal distribution to to the distribution of cat photos). This
